...
AceBuild.config.setModuleUrl(
  "ace/mode/json_worker",
  [
    "widgets",
    require("file-loader!ace-builds/src-noconflict/worker-json.js"),
  ].join("/")
);
...
export class Playground extends Component<{}, PlaygroundState> {
    ...
    return createElement(
      ...
      createElement(
        ...
        createElement(
          SidebarHeader,
          { className: "row" },
          this.renderContent(SidebarHeaderTools)
        ),
        createElement(
          SidebarContent,
          {},
  ...
  private renderContent(
    component: SidebarChildren
  ): ReactChild | (ReactChild | any | boolean)[] | null {
    if (this.props.children && Array.isArray(this.props.children)) {
      ...
      this.props.children.type === component
    ) {
  ...
  private static getStartAndEndPosOfDiff(
    textValue: string,
    diff: Operation
  ): IMarker | null {
