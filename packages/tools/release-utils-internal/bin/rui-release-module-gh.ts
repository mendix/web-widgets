...
import { getModulePackageInfo } from "../src/package-info";
import { addRemoteWithAuthentication, gh } from "../src";

async function main(): Promise<void> {
    // 1. Get widget info
    console.log(`Getting the widget release information...`);
    const packageInfo = await getModulePackageInfo(process.cwd());
    ...
    await gh.createGithubReleaseFrom({
        ...
        notes: "FIXME: Implement changelog parser for modules",
