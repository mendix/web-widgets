...
import { FileDropperContainerProps, UploadModeEnum } from "../../typings/FileDropperProps";
...
export class FileDropperStore {
    ...
    constructor(props: FileDropperContainerProps) {
        ...
        this.translations = new TranslationsStore(props);
    ...
    updateProps(props: FileDropperContainerProps): void {
