...
import { FileDropperStore } from "./FileDropperStore";
...
export class FileStore {
    ...
    _rootStore: FileDropperStore;

    key: number;

    errorDescription?: string = undefined;

    constructor(type: FileStatus, rootStore: FileDropperStore, file?: File, objectItem?: ObjectItem) {
        this.key = getFileKey();
        this._file = file;
    ...
    static existingFile(objectItem: ObjectItem, rootStore: FileDropperStore): FileStore {
    ...
    static newFile(file: File, rootStore: FileDropperStore): FileStore {
        return new FileStore("new", rootStore, file, undefined);
    }

    static newFileWithError(file: File, errorMessage: string, rootStore: FileDropperStore): FileStore {
