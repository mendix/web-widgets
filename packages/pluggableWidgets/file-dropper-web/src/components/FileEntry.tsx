...
export const FileEntryContainer = observer(({ store }: FileEntryContainerProps): ReactElement => {
    ...
    return (
        <FileEntry
            ...
            onRemove={onRemove}
            translations={store._rootStore.translations}
        />
    );
});
    ...
    return (
        ...
        >
            <div className={"entry-details"}>
                ...
                <div className={"entry-details-actions"}>
                    <button
                        ...
                        role={"button"}
                        title={props.translations.get("removeButtonTextMessage")}
                    >
                        &nbsp;
                    </button>
                </div>
            ...
            <div className={"entry-upload-info"}>
                <UploadInfo translations={props.translations} status={props.fileStatus} error={props.errorMessage} />
            </div>
        </div>
    );
}
