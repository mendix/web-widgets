...
import { dynamic, listAttribute } from "@mendix/widget-plugin-test-utils";
...
const commonProps: DatagridDropdownFilterContainerProps = {
    ...
    multiSelect: false,
    clearable: false,
    emptySelectionCaption: dynamic.available("Select"),
    emptyOptionCaption: dynamic.available("None"),
    ariaLabel: dynamic.available("AriaLabel"),
