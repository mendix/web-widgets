# multiselect-keyboard-interaction Specification

## Purpose

TBD - created by archiving change fix-combobox-multiselect-backspace-select-all. Update Purpose after archive.
