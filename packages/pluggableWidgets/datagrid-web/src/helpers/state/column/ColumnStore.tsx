...
export class ColumnStore implements GridColumn {
    ...
    private _attribute?:
        | ListAttributeValue<string | boolean | Date | Big>
        | ListAttributeListValue<string | boolean | Date | Big>
        | undefined = undefined; // as "attribute"
    ...
    get attrId(): ListAttributeValue<string | boolean | Date | Big>["id"] | undefined {
