...
- We fixed an issue where the editor height was not properly adjusted when switching to fullscreen mode.

- We fixed an issue where the resize module configuration was incorrectly applied in readonly mode.
