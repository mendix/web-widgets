# List Style Auto-Cycle Specification

## Purpose

Automatic list style cycling by nesting depth using CSS. Ordered lists cycle decimal → lower-alpha → lower-roman. Unordered lists cycle disc → circle → square.
