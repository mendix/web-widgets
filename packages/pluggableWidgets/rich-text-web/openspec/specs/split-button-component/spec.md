...
Toolbar split button component that combines a main action button with a dropdown menu for related options. Provides Word/Office-like UX pattern with keyboard navigation and accessibility support.
