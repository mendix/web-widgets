...
import { TableCell, tableId, TableTh, TableRow, TableThRow, TableThead } from "../formats/table";
import type {
    CorrectBound,
    Props,
    QuillTableBetter,
...
class TableMenus {
    ...
    createMenus() {
        ...
        for (const [category, val] of Object.entries(getMenusConfig(useLanguage, menus))) {
            ...
            const menu = this.createMenu(icon, "icons icon-Arrow-down", !!children, category);
