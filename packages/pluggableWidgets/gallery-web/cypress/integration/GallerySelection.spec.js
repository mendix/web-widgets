describe("gallery-web", () => {
    ...
    describe("capabilities: selection", () => {
        it("applies single select", () => {
            ...
            cy.get(".mx-name-image1").first().click();
            cy.get(".mx-name-feedback1").hideElement();
        ...
        it("applies multi select", () => {
            ...
            cy.get(".mx-name-gallery1").should("be.visible");
            cy.get(".mx-name-image1").eq(0).click();
            cy.get(".mx-name-image1").eq(1).click();
            cy.get(".mx-name-image1").eq(2).click();
            cy.get(".mx-name-feedback1").hideElement();
