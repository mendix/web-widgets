...
- We fixed an issue where clicking a label inside the item content, such as the label of a checkbox, triggered the double click action with a single click.
